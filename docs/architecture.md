...
5. `05-follow-up-scheduler` runs in UTC, discovers all-account due/retry work, invokes only work with no call-start, and moves expired post-start work to reconciliation.
